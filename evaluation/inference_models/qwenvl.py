...
def get_model(model_dir: str = None) -> Tuple[Qwen2_5_VLForConditionalGeneration, AutoProcessor]:
    """Initialize and return the QwenVL model and processor."""
    global _model, _processor
    
    if model_dir is None:
        model_dir = os.getenv("QWENVL_MODEL_PATH", "Qwen/Qwen2.5-VL-7B-Instruct")
